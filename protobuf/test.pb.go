...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_ba3a4abc73dd8f4a, []int{0}
}
...
func (*HelloResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_ba3a4abc73dd8f4a, []int{1}
}
...
func (c *helloServiceClient) LotsOfReplies(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (HelloService_LotsOfRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/pb.HelloService/LotsOfReplies", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *helloServiceClient) LotsOfGreetings(ctx context.Context, opts ...grpc.CallOption) (HelloService_LotsOfGreetingsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[1], "/pb.HelloService/LotsOfGreetings", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *helloServiceClient) BidiHello(ctx context.Context, opts ...grpc.CallOption) (HelloService_BidiHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[2], "/pb.HelloService/BidiHello", opts...)
	if err != nil {
		return nil, err
	}
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "protobuf/test.proto",
}

func init() { proto.RegisterFile("protobuf/test.proto", fileDescriptor_test_ba3a4abc73dd8f4a) }

var fileDescriptor_test_ba3a4abc73dd8f4a = []byte{
	// 197 bytes of a gzipped FileDescriptorProto
	,
}
